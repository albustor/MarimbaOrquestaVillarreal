            ...
            <div className="grid md:grid-cols-3 gap-6 items-end">
                ...
                <div className="price-card bg-white rounded-xl shadow p-6 flex flex-col relative overflow-hidden">
                    ...
                    <ul className="text-sm space-y-3 mb-6 flex-grow">
                        <li className="flex items-start"><i className="fas fa-check text-green-500 mt-1 mr-2"></i><span>Sesión fotográfica estándar (2 horas).</span></li>
                ...
                <div className="price-card featured rounded-xl shadow-xl p-6 flex flex-col relative overflow-hidden border-2 border-guanacaste-sun">
                    ...
                    <ul className="text-sm space-y-3 mb-6 flex-grow">
                        <li className="flex items-start"><i className="fas fa-check-circle text-fiesta-pink mt-1 mr-2"></i><span className="font-medium">Sesión fotográfica (3-4 horas).</span></li>
                ...
                <div className="price-card bg-white rounded-xl shadow-lg p-6 flex flex-col relative overflow-hidden">
                    ...
                    <ul className="text-sm space-y-3 mb-6 flex-grow">
                        <li className="flex items-start"><i className="fas fa-star text-yellow-500 mt-1 mr-2"></i><span>Sesión día completo (Full Day).</span></li>
